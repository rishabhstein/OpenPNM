...
class LiVoid(GenericPhase):
    ...
    def __init__(self, **kwargs):
        ...
        # Li ion diffusivity in electrolyte, taken from LIONSIMBA paper (Torchio et al 2016)
        self['pore.diffusivity'] = 7.5e-10 
        self['throat.diffusivity'] = 7.5e-10
