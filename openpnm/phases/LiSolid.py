...
class LiSolid(GenericPhase):
    ...
    def __init__(self, **kwargs):
        ...
        # Li ion diffusivity in solid (cathode), taken from LIONSIMBA paper (Torchio et al 2016) 
        self['pore.diffusivity'] = 1e-14
        self['throat.diffusivity'] = 1e-14
